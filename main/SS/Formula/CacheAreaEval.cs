...
{
    public sealed class CacheAreaEval : AreaEvalBase
    {
        /* Value Containter */
        ...
        public CacheAreaEval(int firstRow, int firstColumn, int lastRow, int lastColumn, ValueEval[] values) : base(firstRow, firstColumn, lastRow, lastColumn)
        {
            _values = values;
        }
